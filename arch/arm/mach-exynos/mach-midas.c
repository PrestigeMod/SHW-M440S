...
static uint32_t smdk4x12_keymap[] __initdata = {
	/* KEY(row, col, keycode) */
	KEY(4, 3, KEY_1), KEY(4, 4, KEY_2), KEY(4, 7, KEY_3),
	KEY(11, 3, KEY_4), KEY(11, 4, KEY_5), KEY(11, 7, KEY_D),
	KEY(13, 3, KEY_C), KEY(13, 4, KEY_A), KEY(13, 7, KEY_B),
};
